...
**Relevant code for Chandler M, Zilberman NV, Sprintall J. (2022). Seasonal to decadal western boundary current variability from sustained ocean observations.** ***Geophysical Research Letters.*** **[doi: 10.1029/2022GL097834](https://doi.org/10.1029/2022GL097834)**
...
`Fig1.m`, `Fig1_panels.m`, `Fig2.m`, `Fig3.m`, `Fig4.m`, and `Fig5.m` are the scripts used to produce the figures in the manuscript.
